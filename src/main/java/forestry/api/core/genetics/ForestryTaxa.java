...
public class ForestryTaxa {
	...
	public static final String GENUS_ROCKY = "petrapis";
	public static final String GENUS_METALLIC = "ferrapis";
	public static final String GENUS_GEMSTONE = "gemmapis";
	public static final String GENUS_COPPER = "cuprapis";
	public static final String GENUS_IRON = "ferrumapis";
	public static final String GENUS_TIN = "stannapis";
	public static final String GENUS_GOLD = "aurapis";
	public static final String GENUS_COAL = "carbapis";
	public static final String GENUS_LAPIS = "lazulapis";
	public static final String GENUS_REDSTONE = "pulverapis";
	public static final String GENUS_EMERALD = "smaragdapis";
	public static final String GENUS_DIAMOND = "adamantapis";
	public static final String GENUS_AMETHYST = "amethystapis";
	...
	public static final String SPECIES_STONE = "silex";
	public static final String SPECIES_GRANITE = "graniticus";
	public static final String SPECIES_ANDESITE = "andesiticus";
	public static final String SPECIES_DIORITE = "dioriticus";
	public static final String SPECIES_DEEPSLATE = "profundus";
	public static final String SPECIES_STRUCTURED = "structura";
	public static final String SPECIES_MINERAL = "mineralis";
	public static final String SPECIES_VEINED = "venosus";
	public static final String SPECIES_CRYSTALLINE = "crystallinus";
	public static final String SPECIES_LUSTROUS = "nitidus";
	public static final String SPECIES_OPULENT = "opulentus";
	public static final String SPECIES_BURNISHED = "levigatus";
	public static final String SPECIES_GLISTENING = "fulgens";
	public static final String SPECIES_PULSATING = "pulsans";
	public static final String SPECIES_CARBONISED = "carbonisatus";
	public static final String SPECIES_BRILLIANT = "splendidus";
	public static final String SPECIES_ENVIOUS = "invidus";
	public static final String SPECIES_SERENE = "serenus";
	public static final String SPECIES_CERULEAN = "ultramarinus";
	public static final String SPECIES_CONDUCTIVE = "conductivus";
	public static final String SPECIES_STANNOUS = "stannosus";
	public static final String SPECIES_STALWART = "fortis";
	public static final String SPECIES_REGAL = "regius";
